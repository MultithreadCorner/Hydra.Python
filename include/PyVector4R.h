...
void add_object<hydra::Vector4R>(pybind11::module &m) {
    ...
    py::class_<hydra::Vector4R>(m, "Vector4R")
        ...
        .def("set", (void (hydra::Vector4R::*)(hydra::GReal_t, hydra::GReal_t, hydra::GReal_t,
                             hydra::GReal_t)) &hydra::Vector4R::set)
        .def("__imul__", &hydra::Vector4R::operator*=)
        .def("__itruediv__", &hydra::Vector4R::operator/=)
        .def("assign", [](hydra::Vector4R &v, const hydra::Vector4R &other) { v = other; })
        ...
        .def("swap", &hydra::Vector4R::swap)
        .def("swap", [](hydra::Vector4R &v, hydra::Vector4R &other){ swap(v, other); })
        .def("__repr__", [](const hydra::Vector4R &e) {
            std::stringstream ss;
            ss << e;
            return ss.str();
        })
